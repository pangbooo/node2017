...
describe('Hawk', function () {
    ...
    it('generates a header then successfully parse it (node requests)', function (done) {
    ...
    it('generates a header then successfully parse it (absolute requests uri)', function (done) {
