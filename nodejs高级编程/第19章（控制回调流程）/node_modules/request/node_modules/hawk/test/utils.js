...
describe('Utils', function () {
    ...
    describe('parseHost()', function () {
        ...
        it('returns port 80 for non tls node requests', function (done) {
        ...
        it('returns port 443 for non tls node requests', function (done) {
        ...
        it('returns port 443 for non tls node requests (IPv6)', function (done) {
