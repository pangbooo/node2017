...
/*
   req:                 node's HTTP requests object or an object as follows:
   ...
   options: {
        ...
        payload:               optional payload for validation. The client calculates the hash value and includes it via the 'hash'
                               header attribute. The server always ensures the value provided has been included in the requests
                               MAC. When this option is provided, it validates the hash value itself. Validation is done by calculating
                               a hash value over the entire payload (assuming it has already be normalized to the same format and
                               encoding used by the client to calculate the hash on requests). If the payload is not available at the time
                               of authentication, the authenticatePayload() method can be used by passing it the credentials and
                               attributes.hash returned in the authenticate callback.

        host:                  optional host name override. Only used when passed a node requests object.
        port:                  optional port override. Only used when passed a node requests object.
    }
...
exports.authenticate = function (req, credentialsFunc, options, callback) {
    ...
    // Convert node Http requests object to a requests configuration object
